...
import "/Users/princepatel/Downloads/inventory-management-master/client/src/app/inventory/ahemdabad/vehicles/vehicles.css";
...
function WeaponInventory() {
    ...
    const fetchWeapons = async () => {
      try {
        const response = await axios.get(
          "http://localhost:6789/api/auth/products"
        );
  ...
  return (
    <div className="main-container-9">
      {/* Navbar */}
      <nav className="navbar-9">
        <div className="navbar-logo-9">
          <span>Police Weapon Inventory</span>
        </div>
      </nav>

      <div className="content-container-9">
        {/* <h1 className="text-xl font-bold mt-5 mb-3">Weapon Inventory</h1> */}

        {/* Weapons Table */}
        <table className="weapon-table-9">
          <thead>
            <tr>
              <th>Weapon Name</th>
              <th>Price</th>
        ...
        {/* Pie Charts */}
        <div className="charts-container-9">
          <div className="chart">

...
import "/Users/princepatel/Downloads/inventory-management-master/client/src/app/inventory/bhopal/vehicles/vehicles1.css";
  ...
  return (
    <div className="main-container-5">
      ...
      <nav className="navbar-5">
        <div className="navbar-logo-5">
          <span>Police Vehicles Inventory</span>
        </div>
      </nav>
      ...
      <div className="content-container-5">
        ...
        {/* Weapons Table */}
        <table className="weapon-table-5">
          <thead>
            <tr>
              <th>Weapon Name</th>
              <th>Price</th>
        ...
        {/* Pie Charts */}
        <div className="charts-container-5">

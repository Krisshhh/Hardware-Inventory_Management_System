...
import "/Users/princepatel/Downloads/inventory-management-master/client/src/app/inventory/ahemdabad/weapon/wepone.css";
  ...
  return (
    <div className="main-container-4">
      ...
      <nav className="navbar-4">
        <div className="navbar-logo-4">
          <span>Police Communication Device Inventory</span>
        </div>
      </nav>
      ...
      <div className="content-container-4">
        ...
        {/* Weapons Table */}
        <table className="weapon-table-4">
          <thead>
            <tr>
              <th>Weapon Name</th>
              <th>Price</th>
        ...
        {/* Pie Charts */}
        <div className="charts-container-4">

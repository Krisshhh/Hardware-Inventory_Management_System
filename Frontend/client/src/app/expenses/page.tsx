...
import "./expenses.css"; // Adjust the path as needed
...
const WeaponInventory = () => {
  ...
  // Aggregate total value based on condition
  const totalValueByCondition = weapons.reduce(
    (acc: Record<string, number>, weapon) => {
      const totalValue = weapon.price * weapon.quantity;
      acc[weapon.condition] = (acc[weapon.condition] || 0) + totalValue;
      return acc;
    },
    {}
  );

  // Stock data for another chart (remains unchanged)
  ...
  const statusData = {
    labels: Object.keys(totalValueByCondition),
    datasets: [
      {
        data: Object.values(totalValueByCondition),
    ...
    <div className="main-container">
      ...
      <nav className="navbar">
        <div className="navbar-logo">
          <span>Total Cost Based On Inventory</span>
        </div>
      </nav>
      ...
      <div className="content-container">
        ...
        <div className="charts-container">
          <div className="chart">
            <h2>Condition Value Distribution</h2>
            <Pie data={statusData} />
          </div>
          <div className="chart">
